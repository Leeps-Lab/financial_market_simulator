...
class ELOMarket(BaseModel):
    ...
    market_id = BigIntegerField()
    reference_price = BigIntegerField()
    best_bid = BigIntegerField()
    best_offer = BigIntegerField()
    next_bid = BigIntegerField()
    next_offer = BigIntegerField()
    volume_at_best_bid = BigIntegerField()
    volume_at_best_offer = BigIntegerField()
    e_best_bid = BigIntegerField()
    e_best_offer = BigIntegerField()
    signed_volume = DoubleField()
    e_signed_volume = DoubleField()
    clearing_price = BigIntegerField(null=True)
    transacted_volume = BigIntegerField(null=True)
...
class ELOAgent(BaseModel):
    ...
    delay = FloatField()
    net_worth = BigIntegerField()
    cash = BigIntegerField()
    cost = BigIntegerField()
    speed_cost = BigIntegerField()
    tax_paid = BigIntegerField()
    reference_price = BigIntegerField()
    best_bid = BigIntegerField()
    best_offer = BigIntegerField()
    next_bid = BigIntegerField()
    ...
    e_best_bid = BigIntegerField()
    e_best_offer = BigIntegerField()
    inventory = BigIntegerField()
    bid = BigIntegerField(null=True)
    offer = BigIntegerField(null=True)
    staged_bid = BigIntegerField(null=True)
    staged_offer = BigIntegerField(null=True)
    implied_bid = BigIntegerField(null=True)
    implied_offer = BigIntegerField(null=True)
    best_bid = BigIntegerField()
    best_offer = BigIntegerField()
    best_bid_except_me = BigIntegerField()
    best_offer_except_me = BigIntegerField()
    next_bid = BigIntegerField()
    next_offer = BigIntegerField()
    volume_at_best_bid = BigIntegerField()
    volume_at_best_offer = BigIntegerField()
