...
def mainPlot(investor_arrivals_file_name, external_feed_file_name, investor_plot_name):
    ...
    plt.savefig(investor_plot_name + '.png', bbox_inches = 'tight')
'''
